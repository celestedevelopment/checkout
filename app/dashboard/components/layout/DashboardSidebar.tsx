...
export default function DashboardSidebar({ 
  ...
  return (
    <aside className="w-64 bg-gray-100 border-r border-gray-200 flex-shrink-0">
      <div className="flex flex-col h-full">
        ...
        <div className="flex items-center gap-3 px-6 py-6">
          ...
          <span className="text-gray-900 text-lg font-semibold">Accrual</span>
        </div>
          ...
          <div className="space-y-2">
            ...
            <div className="pt-2">
              <div className="flex items-center gap-2 px-3 py-2">
                ...
                <span className="text-xs text-gray-500">Mama</span>
